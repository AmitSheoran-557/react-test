...
const Product = () => {
    return (
        <div className='product-section d-flex justify-content-center px-lg-0 px-3 align-items-center min-vh-100 bg-deep-blue'>
            <div className="container p-0 mx-auto">
                <div className="d-flex flex-wrap w-100 justify-content-center align-items-center">

                    <div className="col-xl-5 col-12 justify-content-center d-flex ">
                        <div className="box p-6 bg-purple w-100">
                            <h2 className='heading text-white'>Product</h2>
                            <p className='para-font text-white paragraph'>Due to the confusing nature of tax, the lack of awareness of the tax deduction system and the complicated tax refund process, we have experienced exceptional demand from the public for our service. From release in 2015, our original tax product has achieved 60x growth, bringing in over £5m revenue in 2022.</p>
                            <p className='para-font text-white paragraph-two'>With over 8 years of industry experience, we have listened to our clients to evolve our app into a whole-of-market product that will also meet the needs of the tax return market as well as the tax refund market. The App is packed with all the features users need to meet the requirements of the upcoming switch to Making Tax Digital.</p>
                            <p className='para-font text-white paragraph-two'>Once we establish the ourself in the UK, we plan to expand into other territories to take advantage of the £500 billion global market</p>
                            <p className='para-font text-white paragraph-three'>We have highlighted some of our key features that will be the cornerstone of our product launch in April 23.</p>
                        </div>
                    </div>

                    <div className="col-xl-7 col-12 mt-xl-0 mt-lg-5 mt-4 d-flex justify-content-center">
                        <div className="box-2 bg-purple w-100">
                            <div className="d-grid mb-1 image-grid mx-auto justify-content-center">
                                <img className='grid-1' src={gridImg1} alt="img-1" />
                                <img className='grid-2 me-0 me-lg-1' src={gridImg2} alt="img-2" />
                                <img className='grid-3' src={gridImg3} alt="img-3" />
                                <img className='grid-4' src={gridImg4} alt="img-4" />
                            </div>
                            <div className="d-grid image-grid mx-auto justify-content-center">
                                <img className='grid-5' src={gridImg5} alt="img-5" />
                                <img className='grid-6 me-0 me-lg-1' src={gridImg6} alt="img-6" />
                            ...
                            <div className="d-grid image-grid mx-auto justify-content-center">
                                ...
                                <img className='grid-10 me-0 me-lg-1' src={gridImg10} alt="img-10" />
