...
export const COMPETITION_TABLE_LIST = [
    ...
    {
        feature: "Invoicing", rift: <CancelIcon />, taxscout: <CancelIcon />, coconut: <TickIcon />, pie: <TickIcon />,
    },
    {
        feature: "Bookkeeping", rift: <CancelIcon />, taxscout: <CancelIcon />, coconut: <TickIcon />, pie: <TickIcon />,
    },
    {
        feature: "Accountancy support", rift: <TickIcon />, taxscout: <TickIcon />, coconut: <CancelIcon />, pie: <TickIcon />,
    },
    {
        feature: "Tax Filing", rift: <TickIcon />, taxscout: <TickIcon />, coconut: <TickIcon />, pie: <TickIcon />,
    },
    {
        feature: "Fee",
